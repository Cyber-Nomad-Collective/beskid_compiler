//! Validate that a [`CodegenArtifact`] defines every named callee referenced in CLIF.
...
/// A named import in generated CLIF with no matching artifact function entry.
