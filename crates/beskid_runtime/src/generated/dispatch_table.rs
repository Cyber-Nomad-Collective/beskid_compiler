...
fn is_valid_usize_tag(tag: i32) -> bool {
    (0..64).contains(&tag) && (VALID_TAGS_USIZE & (1u64 << tag as u32)) != 0
}

fn is_valid_ptr_tag(tag: i32) -> bool {
    (0..64).contains(&tag) && (VALID_TAGS_PTR & (1u64 << tag as u32)) != 0
}

fn is_valid_unit_tag(tag: i32) -> bool {
    (0..64).contains(&tag) && (VALID_TAGS_UNIT & (1u64 << tag as u32)) != 0
}
