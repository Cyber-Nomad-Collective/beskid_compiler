...
fn field_sdk_doc_lines(attrs: &[Attribute], beskid_ty: &str, stub_note: Option<&str>) -> Vec<String> {
...
mod tests {
    ...
    fn inventory_matches_reflect_sdk_node_kinds() {
        ...
        let inv: BTreeSet<String> =
            inventory_syntax_type_names(&analysis_src).expect("inventory").into_iter().collect();
