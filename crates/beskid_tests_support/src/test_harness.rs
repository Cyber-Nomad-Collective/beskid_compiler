...
pub fn write_project_manifest(dir: impl AsRef<Path>, source: &str) -> PathBuf {
...
pub fn normalize_legacy_project_block(source: &str) -> String {
...
pub fn write_workspace_manifest(dir: impl AsRef<Path>, source: &str) -> PathBuf {
...
pub fn temp_case_dir(prefix: &str) -> PathBuf {
...
#[track_caller]
pub fn assert_same_canonical_path(left: impl AsRef<Path>, right: impl AsRef<Path>) {
    assert_eq!(
