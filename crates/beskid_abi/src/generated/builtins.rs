...
pub const BUILTIN_SPECS: &[BuiltinFnSpec] = &[
    ...
    BuiltinFnSpec { symbol: SYM_ABI_VERSION, params: &[], returns: AbiReturnKind::I64 },
    BuiltinFnSpec { symbol: SYM_COMPOSITION_BIND_PLURAL, params: &PARAMS_2, returns: AbiReturnKind::I32 },
    BuiltinFnSpec { symbol: SYM_COMPOSITION_CONTAINER_CREATE, params: &[], returns: AbiReturnKind::Ptr },
    ...
    BuiltinFnSpec { symbol: SYM_FIBER_YIELD, params: &[], returns: AbiReturnKind::Void },
