...
pub use sources::{
    ...
    CANONICAL_FIBER_SOURCE_PATH, CANONICAL_FOUNDATION_ARRAY_SOURCE_PATH, CANONICAL_FOUNDATION_ASSERT_SOURCE_PATH,
    CANONICAL_FOUNDATION_ERROR_SOURCE_PATH, CANONICAL_FOUNDATION_OUTPUT_SOURCE_PATH,
    CANONICAL_GC_ALLOCATION_SOURCE_PATH, CANONICAL_GC_COLLECTION_SOURCE_PATH, CANONICAL_GC_MARKING_SOURCE_PATH,
    CANONICAL_GC_ROOTS_HANDLES_SOURCE_PATH, CANONICAL_GC_SOURCE_PATH, CANONICAL_GC_STATE_SOURCE_PATH,
    CANONICAL_GC_SWEEP_SOURCE_PATH, CANONICAL_HUB_SOURCE_PATH, CANONICAL_MUTEX_SOURCE_PATH,
