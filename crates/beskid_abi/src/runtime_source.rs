...
pub use sources::{
    ...
    CANONICAL_CORELIB_CONSOLE_LINUX_SOURCE_PATH, CANONICAL_CORELIB_FIBER_SOURCE_PATH,
    CANONICAL_CORELIB_HUB_SOURCE_PATH, CANONICAL_CORELIB_MUTEX_SOURCE_PATH, CANONICAL_CORELIB_SYSCALL_SOURCE_PATH,
    CANONICAL_CORELIB_WAIT_GROUP_SOURCE_PATH, CANONICAL_DYNAMIC_SOURCE_PATH, CANONICAL_EVENTS_SOURCE_PATH,
