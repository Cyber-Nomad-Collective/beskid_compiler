...
pub use symbols::{
    ...
    SYM_FIBER_CURRENT_ID, SYM_FIBER_DETACH, SYM_FIBER_JOIN, SYM_FIBER_JOIN_VALUE,
    SYM_FIBER_NOW_MILLIS, SYM_FIBER_SPAWN, SYM_FIBER_YIELD, SYM_GC_BYTES_ALLOCATED, SYM_GC_COLLECT,
