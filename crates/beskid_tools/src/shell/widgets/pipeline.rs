...
use crate::pipeline::tui::widgets::{draw_context_bar, draw_pipeline_tree, draw_progress_footer, draw_stage_panel};
...
impl BeskidWidget for HeaderWidget {
    fn meta(&self) -> WidgetMeta {
        WidgetMeta { id: "shell.header", title: "Header", icon: "—" }
    }
...
impl BeskidWidget for StageWidget {
    fn meta(&self) -> WidgetMeta {
        WidgetMeta { id: "pipeline.stage", title: "Stage", icon: "◆" }
    }
    fn hotkeys(&self, _ctx: &WidgetContext<'_>) -> Vec<Hotkey> {
        Vec::new()
    }
...
impl BeskidWidget for DetailWidget {
    fn meta(&self) -> WidgetMeta {
        WidgetMeta { id: "pipeline.detail", title: "Detail", icon: "▤" }
    }
    fn hotkeys(&self, _ctx: &WidgetContext<'_>) -> Vec<Hotkey> {
        Vec::new()
    }
    ...
    fn render(&self, area: Rect, frame: &mut Frame, ctx: &mut WidgetContext<'_>) {
        ...
        draw_pipeline_tree(frame, area, &ctx.shell_state.tree_nodes, &mut ctx.shell_state.tree_state, title);
    }
}
...
impl BeskidWidget for FooterWidget {
    fn meta(&self) -> WidgetMeta {
        WidgetMeta { id: "pipeline.footer", title: "Progress", icon: "▬" }
    }
    fn hotkeys(&self, _ctx: &WidgetContext<'_>) -> Vec<Hotkey> {
        Vec::new()
    }
