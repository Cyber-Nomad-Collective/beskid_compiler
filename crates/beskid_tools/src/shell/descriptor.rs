...
pub const BUILTIN_DESCRIPTORS: &[WidgetDescriptor] = &[
    ...
    WidgetDescriptor::new("graph.deps", "Dependency graph", "◎", "Workspace/project graph", Some(1)),
    WidgetDescriptor::new("graph.compile", "Compile graph", "◈", "Pipeline phase tree", Some(1)),
    WidgetDescriptor::new("compile.debugger", "Compile debugger", "▣", "Phase timeline and traces", Some(1)),
    WidgetDescriptor::new("debug.future", "Debugger", "◉", "Compile debugger timeline", Some(1)),
    WidgetDescriptor::new("pipeline.stage", "Stage", "◆", "Pipeline stage panel", Some(1)),
    WidgetDescriptor::new("pipeline.detail", "Detail", "▤", "Pipeline detail tree", Some(2)),
    WidgetDescriptor::new("pipeline.log", "Build log", "≡", "Pipeline log tabs", None),
    WidgetDescriptor::new("pipeline.footer", "Progress", "▬", "Pipeline progress footer", None),
];
