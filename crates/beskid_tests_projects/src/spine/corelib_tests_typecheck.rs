...
//! ```bash
//! BESKID_CORELIB_SPINE_SMOKE=1 cargo test -p beskid_tests_projects corelib_tests_front_end_typechecks_matrix -- --nocapture --test-threads=1
//! ```
//!
//! **Skip entirely** (local iteration on unrelated crates):
//! ```bash
//! BESKID_SKIP_CORELIB_SPINE=1 cargo test -p beskid_tests_projects
//! ```
//!
//! **Bisect one entry** (ignored per-entry tests):
//! ```bash
//! cargo test -p beskid_tests_projects text_cursor_tests_front_end_typechecks -- --ignored --nocapture --test-threads=1
//! ```
//!
...
corelib_typecheck_test!(system_syscall_write_tests_front_end_typechecks, "system/SyscallWriteTests.bd");
corelib_typecheck_test!(system_syscall_api_tests_front_end_typechecks, "system/SyscallApiTests.bd");
corelib_typecheck_test!(system_syscall_ergonomics_tests_front_end_typechecks, "system/SyscallErgonomicsTests.bd");
corelib_typecheck_test!(system_output_write_line_tests_front_end_typechecks, "system/OutputWriteLineTests.bd");
corelib_typecheck_test!(system_output_write_tests_front_end_typechecks, "system/OutputWriteTests.bd");
corelib_typecheck_test!(console_ansi_escape_tests_front_end_typechecks, "console/AnsiEscapeTests.bd");
corelib_typecheck_test!(console_ansi_style_chain_tests_front_end_typechecks, "console/AnsiStyleChainTests.bd");
corelib_typecheck_test!(console_format_markdown_tests_front_end_typechecks, "console/FormatMarkdownTests.bd");
corelib_typecheck_test!(console_ansi_sgr_golden_tests_front_end_typechecks, "console/AnsiSgrGoldenTests.bd");
corelib_typecheck_test!(console_controls_panel_tests_front_end_typechecks, "console/ControlsPanelTests.bd");
corelib_typecheck_test!(controls_progress_bar_tests_front_end_typechecks, "console/ControlsProgressBarTests.bd");
corelib_typecheck_test!(console_controls_layout_tests_front_end_typechecks, "console/ControlsLayoutTests.bd");
corelib_typecheck_test!(system_input_read_tests_front_end_typechecks, "system/InputReadTests.bd");
corelib_typecheck_test!(system_error_write_tests_front_end_typechecks, "system/ErrorWriteTests.bd");
...
corelib_typecheck_test!(core_encoding_utf8_tests_front_end_typechecks, "core/EncodingUtf8Tests.bd");
corelib_typecheck_test!(core_expression_body_tests_front_end_typechecks, "core/ExpressionBodyTests.bd");
...
corelib_typecheck_test!(collections_stack_tests_front_end_typechecks, "collections/StackTests.bd");
...
corelib_typecheck_test!(hub_register_tests_front_end_typechecks, "concurrency/HubRegisterTests.bd");
corelib_typecheck_test!(wait_group_tests_front_end_typechecks, "concurrency/WaitGroupTests.bd");
corelib_typecheck_test!(fiber_handle_tests_front_end_typechecks, "concurrency/FiberHandleTests.bd");
corelib_typecheck_test!(console_message_channel_tests_front_end_typechecks, "console/ConsoleMessageChannelTests.bd");
corelib_typecheck_test!(console_capabilities_tests_front_end_typechecks, "console/CapabilitiesTests.bd");
corelib_typecheck_test!(console_terminal_platform_tests_front_end_typechecks, "console/TerminalPlatformTests.bd");
corelib_typecheck_test!(console_facade_tests_front_end_typechecks, "console/ConsoleFacadeTests.bd");
corelib_typecheck_test!(console_format_attributes_tests_front_end_typechecks, "console/FormatAttributesTests.bd");
corelib_typecheck_test!(console_format_scan_tests_front_end_typechecks, "console/FormatScanTests.bd");
...
corelib_typecheck_test!(text_casing_tests_front_end_typechecks, "text/TextCasingTests.bd");
corelib_typecheck_test!(text_parser_combinator_tests_front_end_typechecks, "text/TextParserCombinatorTests.bd");
corelib_typecheck_test!(pest_grammar_parse_tests_front_end_typechecks, "text/PestGrammarParseTests.bd");
corelib_typecheck_test!(pest_emit_golden_tests_front_end_typechecks, "text/PestEmitGoldenTests.bd");
corelib_typecheck_test!(text_regex_integration_tests_front_end_typechecks, "text/TextRegexIntegrationTests.bd");
