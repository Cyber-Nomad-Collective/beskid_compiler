...
pub const CORELIB_TYPECHECK_ENTRIES: &[&str] = &[
    ...
    "core/RandomTests.bd",
    "core/ArgsTests.bd",
    "core/ErrorHandlingTests.bd",
    "core/StringTests.bd",
    "core/ProcessTests.bd",
    "core/ThreadingTests.bd",
    ...
    "query/QueryTests.bd",
    "query/QueryIteratorConformanceTests.bd",
    "system/FsTests.bd",
    "system/PathTests.bd",
    "system/TimeTests.bd",
    "system/EnvironmentTests.bd",
    "system/RuntimeInitTests.bd",
    ...
    "network/TypesTests.bd",
    "network/DnsTests.bd",
    "network/TcpTests.bd",
    "network/UdpTests.bd",
    "network/ScopeTests.bd",
