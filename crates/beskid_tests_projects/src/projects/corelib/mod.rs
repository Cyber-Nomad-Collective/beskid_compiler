...
pub(super) fn expected_corelib_workspace_sources() -> &'static [&'static str] {
    &[
        ...
        "packages/foundation/src/Core/Collections/Array/ArrayIter.bd",
        "packages/foundation/src/Core/Collections/List.bd",
        "packages/foundation/src/Core/Collections/Map.bd",
        "packages/foundation/src/Core/Collections/Map/MapEntry.bd",
        "packages/foundation/src/Core/Collections/Queue.bd",
        "packages/foundation/src/Core/Collections/Set.bd",
        "packages/foundation/src/Core/Collections/Stack.bd",
        ...
        "packages/foundation/src/Core/String/Core.bd",
        "packages/foundation/src/Core/String/Chars.bd",
        "packages/foundation/src/Core/String/Utf8.bd",
        ...
        "packages/foundation/src/Query/Iterator.bd",
