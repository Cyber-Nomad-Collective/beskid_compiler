use crate::hir::{HirExpressionNode, HirPattern, HirStructLiteralField};
use crate::syntax::Spanned;

use super::super::resolver::Resolver;

impl Resolver {
    pub(super) fn resolve_expression(&mut self, expression: &Spanned<HirExpressionNode>) {
    ...
    pub(super) fn resolve_match_arm(&mut self, arm: &Spanned<crate::hir::HirMatchArm>) {
        self.push_scope();
    ...
    pub(super) fn resolve_pattern(&mut self, pattern: &Spanned<HirPattern>) {
        match &pattern.node {
            HirPattern::Wildcard => {}
    ...
    pub(super) fn resolve_struct_literal_field(&mut self, field: &Spanned<HirStructLiteralField>) {
