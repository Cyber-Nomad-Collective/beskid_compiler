...
pub enum CompositionIssue {
    ...
    MultipleLaunchHosts {
        first_span: Option<SpanInfo>,
        second_span: Option<SpanInfo>,
    },
    UnknownLaunchHost {
        host_name: String,
        span: SpanInfo,
    },
    HostInheritanceCycle {
        host_name: String,
        span: SpanInfo,
    },
    DuplicateScopeName {
    ...
    ChildScopeWithoutParent {
        scope_name: String,
        span: SpanInfo,
    },
    InvalidScopeQualifier {
        qualifier: String,
        span: SpanInfo,
    },
    OverrideLifetimeMismatch {
        binding: String,
        span: SpanInfo,
    },
    InjectOnConstructor {
...
pub fn to_semantic_issue(issue: &CompositionIssue) -> Option<(SpanInfo, SemanticIssueKind)> {
    match issue {
        CompositionIssue::MissingLaunchHost { span } => Some((
            span.unwrap_or_default(),
            SemanticIssueKind::CompositionMissingLaunchHost,
        )),
        CompositionIssue::MultipleLaunchHosts {
            first_span,
            second_span,
        } => Some((
            (*second_span)
        ...
        CompositionIssue::UnknownLaunchHost { host_name, span } => Some((
            *span,
            SemanticIssueKind::CompositionLaunchTargetNotHost {
                target_name: host_name.clone(),
            },
        )),
        CompositionIssue::HostInheritanceCycle { host_name, span } => Some((
            *span,
        ...
        CompositionIssue::AmbiguousInject {
            requested_type,
            span,
        } => Some((
            *span,
        ...
        CompositionIssue::UnresolvedInject {
            requested_type,
            span,
        } => Some((
            *span,
        ...
        CompositionIssue::EmptyPluralInject {
            requested_type,
            span,
        } => Some((
            *span,
        ...
        CompositionIssue::WithArgsMismatch { scope_name, span } => Some((
            *span,
        ...
        CompositionIssue::InvalidScopeQualifier { qualifier, span } => Some((
            *span,
