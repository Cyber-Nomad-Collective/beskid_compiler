...
// ABI-v5 canonical runtime declarations
    ...
    &["network_reactor_create"] => {
        symbol: "beskid_rt_v5_intrinsic_network_reactor_create",
        params: [],
        returns: Ptr,
        injected: true,
    },
    &["network_reactor_destroy"] => {
        symbol: "beskid_rt_v5_intrinsic_network_reactor_destroy",
        params: [Ptr],
        returns: Unit,
        injected: true,
    },
    ...
    &["network_cancel"] => {
        symbol: "beskid_rt_v5_intrinsic_network_cancel",
        params: [Ptr, Ptr],
        returns: Unit,
        injected: true,
    },
    ...
    &["network_table_lock"] => {
        symbol: "beskid_rt_v5_intrinsic_network_table_lock",
        params: [],
        returns: Unit,
        injected: true,
    },
    &["network_table_unlock"] => {
        symbol: "beskid_rt_v5_intrinsic_network_table_unlock",
        params: [],
        returns: Unit,
        injected: true,
    },
    &["network_table_root"] => {
        symbol: "beskid_rt_v5_intrinsic_network_table_root",
        params: [],
        returns: Ptr,
        injected: true,
    },
    ...
    &["network_dns_release"] => {
        symbol: "beskid_rt_v5_intrinsic_network_dns_release",
        params: [Ptr],
        returns: Unit,
        injected: true,
    },
