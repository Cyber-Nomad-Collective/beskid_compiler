...
pub use assembly::{
    ...
    assembly_options_for_prepare, build_hir_units, effective_roots_for_plan, effective_roots_from_lockfile,
...
pub use discovery::{
    ...
    WORKSPACE_MANIFEST_EXTENSION, discover_project_file, discover_project_file_descendant,
    discover_project_manifest_in_dir, discover_workspace_file, discover_workspace_file_descendant,
