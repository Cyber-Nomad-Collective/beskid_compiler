...
#[derive(beskid_ast_derive::PhaseFromAst, Debug, Clone, PartialEq, Eq, beskid_ast_derive::HirNode)]
#[ast(kind = "Literal")]
...
pub fn integer_literal_magnitude(text: &str) -> &str {
    text.strip_suffix("_i64").or_else(|| text.strip_suffix("_i32")).or_else(|| text.strip_suffix("_u8")).unwrap_or(text)
}
