...
impl Cell {
    ...
    #[cfg(test)]
    pub fn with_attrs(self, attrs: crate::primitives::termtui::vt100::attrs::Attrs) -> Cell {
        Cell { attrs, ..self }
    }

    pub(crate) fn set(&mut self, c: char, a: crate::primitives::termtui::vt100::attrs::Attrs) {
        self.text.clear();
        self.text.push(c);
        self.attrs = a;
    }
    ...
    pub(crate) fn clear(&mut self, attrs: crate::primitives::termtui::vt100::attrs::Attrs) {
        self.text.clear();
        self.attrs = attrs;
    }
    ...
    pub(crate) fn attrs(&self) -> &crate::primitives::termtui::vt100::attrs::Attrs {
        &self.attrs
    }

    pub(crate) fn set_attrs(&mut self, attrs: crate::primitives::termtui::vt100::attrs::Attrs) {
        self.attrs = attrs;
    }
}
